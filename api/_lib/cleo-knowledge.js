...
- schedule_unit puts a unit on the calendar so it shows in "Today". Resolve the class and unit; the teacher picks the actual date on the confirmation card (it defaults to today), so don't assume or ask for a date — just propose it and invite them to confirm.
