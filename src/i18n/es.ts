...
const es: Locale = {
  ...
  studioCommon: {
    ...
    riskScoreTitle: (s) => `Score: ${s}/100`,
    chartPrevPeriod: "Período anterior",
    chartForecast: "Pronóstico Cleo",
    chartVsBucket: "vs bucket anterior",
  },
  ...
  classDetail: {
    ...
    compositionEmpty: "Sin respuestas en esta ventana.",
    correct: "Correcto",
    incorrect: "Incorrecto",
    responsesLower: "respuestas",
    trendEmpty: "Sin datos en esta ventana.",
    metricPctCorrect: "% correcto",
    metricAvgTime: "Tiempo medio",
    metricParticipation: "Participación",
    topDominated: "Top temas dominados",
    topCritical: "Top temas críticos",
    noTopics: "Sin temas registrados.",
    topicTooltipHighlight: (label, val) => `${label}: ${val}% de retención · clic para resaltar sus preguntas`,
    topicTooltipView: (label, val) => `${label}: ${val}% de retención · clic para ver el tema`,
    mostMissedTitle: "Más falladas",
    highlighting: (topic) => `Resaltando: ${topic}`,
    notEnoughData: "Sin datos suficientes.",
    qErr: (p) => `${p}% err`,
    qLabel: (n) => `P. ${n}`,
    genReviewTitle: "Crea un deck de repaso de lo más fallado",
    atRiskTopics: "Temas en riesgo",
    avgTimeLabel: "Tiempo promedio",
    participationLabel: "Participación",
    compare: "Comparar",
    drawerSummaryOf: (name) => `Resumen de ${name}`,
    close: "Cerrar",
    weakestTopics: "Temas más flojos",
    noTopicData: "Sin datos de temas.",
    riskSignals: "Señales de riesgo",
    viewFullProfile: "Ver perfil completo →",
    cleoLabel: "Cleo:",
    cleoAnalyzing: "Cleo está analizando los datos…",
    cleoWeakTopics: (topics) => `Los temas con menor retención son: ${topics}.`,
    cleoNoData: "Sin datos suficientes en esta ventana de fechas.",
    cleoGenError: (err) => `No pude generar el repaso (${err}). Intenta de nuevo.`,
    cleoChipGenerate: "Generar repaso de lo flojo",
    cleoChipGenerating: "Generando…",
    cleoChipReteach: "Reenseñar ahora",
    cleoChipTomorrow: "Que vuelva mañana",
    cleoChipSoon: "pronto",
    cleoGenerateTitle: "Crea un deck de repaso de 7 preguntas sobre los temas más débiles",
    cleoReteachTitle: "Salta al panel de preguntas más falladas",
    cleoTomorrowTitle: "Llega cuando se sume el scheduler de tareas",
  },
  ...
  studentProfile: {
    studentTitle: (name) => `Estudiante: ${name}`,
    errorLoading: (msg) => `Error cargando el perfil: ${msg}`,
    avgRetention: "Retención media",
    deltaVsClass: "Δ vs clase",
    trajectoryWeekly: "Trayectoria · % correcto semanal",
    noDataWindow: "Sin datos en esta ventana.",
    mostFailedTitle: "Más falladas por el alumno",
    notEnoughData: "Sin datos suficientes.",
    qLabel: (n) => `P. ${n}`,
    qErr: (p) => `${p}% err`,
    assignReview: "Asignar repaso",
    assignReviewTitle: "Crea un deck de repaso enfocado en este alumno",
    generating: "Generando…",
    masteryMatrix: "Matriz de dominio",
    noTopicsYet: "Sin temas registrados todavía.",
    topicCountHint: (n, word) => `${n} ${word} · click selecciona`,
    topicWord: "tema",
    topicWordPlural: "temas",
    tierStrong: "fuerte",
    tierWeak: "flojo",
    tierCritical: "crítico",
    calculatingRisk: "Calculando riesgo…",
    noRiskData: "Sin datos de riesgo para este alumno.",
    riskAnalysis: (name) => `Análisis de riesgo${name ? ` — ${name}` : ""}`,
    riskLevel: "Nivel de riesgo",
    noRiskSignals: "Sin señales de riesgo detectadas en la ventana actual.",
    cleoLabel: "Cleo:",
    cleoAnalyzingStudent: "Cleo está analizando al alumno…",
    cleoReinforce: (topics) => `Temas a reforzar: ${topics}.`,
    cleoAboveAvg: (d) => `Está ${d}% por encima de la media de la clase.`,
    cleoBelowAvg: (d) => `Está ${d}% por debajo de la media de la clase.`,
    cleoNoData: "Sin datos suficientes en esta ventana.",
    cleoGenError: (err) => `No pude generar el repaso (${err}). Intenta de nuevo.`,
    cleoAssign: "Asignarle repaso",
    cleoAssignTitle: "Crea un deck de repaso enfocado en este alumno",
    cleoFamilyMsg: "Mensaje a familia",
    cleoFamilyTitle: "Llega cuando se sume mensajería a familias",
    soon: "pronto",
    histTitle: "Historial de sesiones",
    histEmpty: "Sin sesiones todavía.",
    colDate: "Fecha",
    colDeck: "Deck",
    colScore: "Puntaje",
  ...
  topicMastery: {
    title: "Temas",
    error: (msg) => `Error: ${msg}`,
    trendOf: (topic) => `Tendencia · ${topic}`,
    noTopicData: "Sin datos para este tema.",
    questionsTitle: "Preguntas del tema",
    noQuestions: "Sin preguntas para este tema.",
    qLabel: (n) => `P. ${n}`,
    misconceptionTitle: "Concepto erróneo",
    selectQuestion: "Selecciona una pregunta para ver el análisis.",
    correctAnswer: "Respuesta correcta:",
    topWrong: "Más elegida (incorrecta):",
    chosePct: (n) => `${n}% eligió esta opción`,
    otherQuestions: "Otras preguntas falladas",
    noOtherQuestions: "Sin preguntas adicionales con error en esta ventana.",
    misconceptionSubtitle: "Concepto erróneo · pregunta más fallada",
    dominantMis: "Concepto erróneo dominante:",
    chosenSentence: (count, pct) => `elegida ${count} ${count === 1 ? "vez" : "veces"} (${pct}% del total).`,
    optionN: (n) => `Opción ${n}`,
    trueLabel: "Verdadero",
    falseLabel: "Falso",
    correctMark: "✓ correcta",
    viewInDeck: "Ver pregunta en DeckResults",
    noFeatured: "Sin pregunta destacada en este tema.",
    errShort: (p) => `${p}% err`,
  },
  ...
  reportModel: {
    ...
    sessions: "Sesiones",
    colClass: "Clase",
    reportTitle: (name, period) => `Reporte — ${name} (${period})`,
    overviewReportTitle: (period) => `Reporte general (${period})`,
    qPrefix: (n) => `P. ${n}`,
  },
  ...
  cleoChat: {
    ...
    action: {
      ...
      working: "Trabajando…",
      generating: "Creando el quiz — esto puede tardar un momento…",
      ...
      fieldSection: "Tipo",
      fieldSource: "Desde",
      fieldCount: "Preguntas",
      sectionWarmup: "Warmup",
      sectionExit: "Exit ticket",
      sectionGeneral: "General",
      sourceDocument: "Tu documento",
      sourceTopic: "Un tema",
      ...
      doneDeck: "Listo — “{name}” quedó como borrador con {count} preguntas.",
      viewClass: "Abrir clase",
      viewUnit: "Abrir clase",
      viewReview: "Ver en la biblioteca",
      viewDeck: "Ver en la biblioteca",
      ...
      // Editar / mover / borrar (Track B3)
      fieldNewName: "Nuevo nombre",
      fieldDeck: "Deck",
      fieldTo: "A",
      classLevel: "Nivel de clase (sin unidad)",
      renameClassTitle: "Renombrar clase",
      renameUnitTitle: "Renombrar unidad",
      renameDeckTitle: "Renombrar deck",
      moveDeckTitle: "Mover deck",
      deleteDeckTitle: "Borrar deck",
      deleteUnitTitle: "Borrar unidad",
      deleteClassTitle: "Borrar clase",
      deleteCta: "Borrar",
      deleteKeyword: "borrar",
      deleteWarn: "Esto no se puede deshacer.",
      deleteClassWarn: "Esto borra la clase completa de forma permanente — {students} alumnos y {decks} decks. No se puede deshacer.",
      typeToConfirm: "Escribe «{name}» para confirmar:",
      doneRenamed: "Listo — renombrado a «{name}».",
      doneMoved: "Listo — moví «{name}» a {unit}.",
      doneMovedToClass: "Listo — moví «{name}» al nivel de clase.",
      doneDeleted: "Listo — borré «{name}».",
      viewClasses: "Mis clases",
    },
    // Tarjeta de plan multi-paso (Cleo encadena varias acciones en una confirmación).
    plan: {
      heading: "Esto es lo que haré",
      prompt: "Esto es lo que haré — confirma abajo 👇",
      confirm: "Confirmar y crear",
      cancel: "Cancelar",
      editNames: "Editar nombres",
      adjust: "Ajustar",
      working: "…",
      runningNote: "Trabajando en ello…",
      summary: "{done} de {total} completados",
      retry: "Reintentar el resto",
      canceled: "Listo — no lo haré.",
      view: "Ver",
      viewReport: "Ver reporte",
      open: "Abrir",
      launch: "Lanzar",
      openPlanner: "Abrir planner",
      sumCreateClass: "Crear la clase «{name}»",
      sumCreateUnit: "Crear la unidad «{name}» en {class}",
      sumCreateUnits: "Crear {n} unidades en {class}",
      sumCreateDeck: "Crear un quiz para {class}",
      sumReview: "Generar un repaso de «{unit}» ({class})",
      sumReport: "Abrir el reporte de {class}",
      sumOpen: "Llevarte ahí",
      sumLaunch: "Lanzar «{deck}»",
      sumSchedule: "Planificar «{unit}» en el calendario",
      classLevel: "el nivel de clase",
      sumRenameClass: "Renombrar la clase a «{new}»",
      sumRenameUnit: "Renombrar «{unit}» → «{new}» en {class}",
      sumRenameDeck: "Renombrar deck «{deck}» → «{new}»",
      sumMoveDeck: "Mover «{deck}» a {to}",
      sumDeleteDeck: "Borrar deck «{deck}»",
      sumDeleteUnit: "Borrar unidad «{unit}» ({class})",
      sumDeleteClass: "Borrar la clase completa «{class}»",
    },
  },
  ...
  classReport: {
    eyebrow: "Reporte de clase",
    print: "Imprimir / Guardar PDF",
    back: "Volver a la clase",
    generated: "Generado el {date}",
    loading: "Preparando el reporte…",
    error: "No pude cargar el reporte. Inténtalo de nuevo en un momento.",
    emptyTitle: "Aún no hay datos",
    emptyBody: "Corre unos warmups o exit tickets y el reporte se llenará con los temas más difíciles y quién necesita ayuda.",
    kpiStudents: "Estudiantes",
    kpiTopics: "Temas",
    kpiAvgRetention: "Retención prom.",
    distributionTitle: "Retención por tema",
    tierStrong: "fuertes",
    tierMedium: "a repasar",
    tierWeak: "débiles",
    hardestTitle: "Temas más difíciles",
    strongestTitle: "Temas más fuertes",
    studentsTitle: "Estudiantes que necesitan ayuda",
    answered: "{n} respondidas",
    noTopics: "Aún no hay temas registrados.",
    noStudents: "Aún no hay datos de estudiantes.",
  },
  ...
  decks: {
    ...
    aiImgCoverageLabel: "Cuántas imágenes",
    aiImgCoverageFew: "Pocas (auto)",
    aiImgCoverageSome: "~30% (recomendado)",
    aiImgCoverageAll: "Todas las preguntas",
    ...
    aiImagesAiPartialMsg: "Añadí {generated} imagen(es) generada(s) con IA. Quité {dropped} pregunta(s) cuya imagen no pasó el control de calidad.",
    aiImagesAiFailedMsg: "No se pudieron generar imágenes con IA adecuadas esta vez. Quité {dropped} pregunta(s) que iban a llevar una.",
