...
const es: Locale = {
  ...
  decks: {
    ...
    aiImagesLabel: "Imágenes",
    aiImagesAttach: "Ilustrar las preguntas con imágenes",
    aiImagesAbout: "Crear preguntas sobre las imágenes",
    aiImagesOff: "Sin imágenes",
    aiImagesHintAttach: "La imagen acompaña a la pregunta como apoyo visual; la pregunta se entiende igual sin ella.",
    aiImagesHintAbout: "La pregunta trata directamente sobre la imagen; no se puede responder sin verla.",
    aiImagesHintOff: "No se usarán las imágenes del documento.",
    aiImagesAddedMsg: "Añadí {attached} imagen(es) de tu documento a las preguntas.",
    aiImagesNoneMsg: "Encontré {found} imagen(es) en tu archivo, pero ninguna encajó en una pregunta — prueba \"Crear preguntas sobre las imágenes\".",
