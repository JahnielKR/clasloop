...
const ko: Locale = {
  ...
  tours: {
    ...
    home: {
      ...
      steps: [
        { title: "첫 수업 만들기", body: "여기를 눌러 수업을 만드세요. 워밍업, 학생, 세션 모두 수업 안에 들어갑니다." },
        { title: "코드 공유하기", body: "모든 수업에는 참여 코드가 있어요. 학생들은 무료 계정이나 Google 로그인으로 앱에 코드를 입력해 수업에 참여합니다." },
      ],
    },
    classDetail: {
      offer: "수업을 둘러볼까요? 둘러보는 방법, 단원 만들기, 학생 초대 방법을 보여드릴게요.",
      steps: [
        { title: "수업 둘러보기", body: "현재 단원, 지난·예정 단원, 종합 복습을 여기서 전환하세요." },
        { title: "단원 만들기", body: "단원은 주제입니다(예: '분수'). 매일의 워밍업과 exit ticket이 그 안에 들어갑니다. 여기서 시작하세요." },
        { title: "학생 초대하기", body: "수업 코드를 공유하세요. 학생들은 무료 계정이나 Google 로그인 후 앱에 코드를 입력해 참여합니다." },
        { title: "이게 전부예요!", body: "단원을 만들고 그날의 워밍업을 추가한 뒤 코드를 공유하세요. 언제든 다시 볼 수 있어요." },
      ],
    },
    deckEditor: {
      offer: "첫 워밍업을 만드는 방법을 보여드릴까요? 금방이에요.",
      steps: [
        { title: "덱 이름 짓기", body: "이름을 지어 주세요 — 이름이 없으면 저장할 수 없어요." },
        { title: "클래스 선택", body: "어느 수업에 속하는지 선택하세요. 그 수업의 과목과 학년을 자동으로 가져옵니다." },
        { title: "세션 유형", body: "워밍업, exit ticket, 종합 복습 중에서 표시하세요 — 수업에서 나타나는 위치가 정해집니다." },
        { title: "언어 선택", body: "덱의 언어를 선택하세요. AI가 그 언어로 문제를 생성하고 검토합니다." },
        { title: "AI로 생성", body: "파일을 올리거나 주제를 입력하면 AI가 문제를 만들고 검토합니다. 직접 추가할 수도 있어요." },
        { title: "저장하면 끝", body: "저장을 누르세요. 덱이 라이브 실행이나 인쇄에 바로 사용할 수 있습니다." },
      ],
    },
    pdfExport: {
      offer: "이 덱을 종이로 옮기는 방법을 보여드릴까요?",
      steps: [
        { title: "문제 인쇄하기", body: "어떤 덱이든 PDF로 내보내 수업에서 나눠주거나 화면 없이 시험을 볼 수 있어요." },
        { title: "유형 선택", body: "시험, 정답지, 또는 휴대폰으로 채점하는 스캔 가능한 시험 중에서 고르세요." },
        { title: "스타일 선택", body: "인쇄에 바로 쓸 수 있는 여러 디자인이 있어요. 원하는 것을 고르세요." },
        { title: "PDF 다운로드", body: "여기를 눌러 다운로드하세요. 나중에 휴대폰 스캐너로 답안지를 채점할 수 있어요." },
      ],
    },
    scanner: {
      offer: "카메라로 종이 시험을 채점하는 방법을 보여드릴까요?",
      steps: [
        { title: "카메라로 채점", body: "답안지를 사진으로 찍으면 스캐너가 즉시 채점합니다." },
        { title: "답안지 스캔", body: "시험을 고르고 학생의 답안지를 맞추면 스캐너가 나머지를 처리합니다." },
        { title: "확인 후 저장", body: "확실하지 않은 표시는 강조해 드려요. 확인한 뒤 점수를 저장하세요." },
      ],
    },
  },
