  ...
  tours: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "코드 공유하기", body: "모든 수업에는 6자리 코드가 있어요. 학생들은 계정이나 이메일 없이 휴대폰으로 입력해 참여합니다." },
      ],
    },
    classDetail: {
      ...
      steps: [
        ...
        { title: "학생 초대하기", body: "이 코드를 수업과 공유하세요. 앱에 입력하면 계정 없이 바로 참여합니다." },
    ...
    deckEditor: {
      ...
      steps: [
        { title: "섹션 선택", body: "워밍업, exit ticket, 종합 복습 중에서 표시하세요. 수업의 올바른 위치에 나타납니다." },
        { title: "문제 추가", body: "'문제' 탭에서 AI로 생성하거나 직접 추가할 수 있어요." },
