...
const ko: Locale = {
  ...
  decks: {
    ...
    aiImagesLabel: "이미지",
    aiImagesAttach: "이미지로 문제 보강",
    aiImagesAbout: "이미지에 대한 문제 만들기",
    aiImagesOff: "이미지 없음",
    aiImagesHintAttach: "이미지는 문제 옆에 시각적 보조로 들어갑니다 — 이미지 없이도 문제가 성립합니다.",
    aiImagesHintAbout: "문제가 이미지 자체에 관한 것입니다 — 이미지를 보지 않으면 답할 수 없습니다.",
    aiImagesHintOff: "문서의 이미지를 사용하지 않습니다.",
    aiImagesAddedMsg: "문서의 이미지 {attached}개를 문제에 추가했습니다.",
    aiImagesNoneMsg: "파일에서 이미지 {found}개를 찾았지만 어떤 문제에도 맞지 않았습니다 — \"이미지에 대한 문제 만들기\"를 시도해 보세요.",
