...
const en = {
  ...
  studioCommon: {
    ...
    riskScoreTitle: (s: number) => `Score: ${s}/100`,
    chartPrevPeriod: "Previous period",
    chartForecast: "Cleo forecast",
    chartVsBucket: "vs prev. bucket",
  },
  ...
  classDetail: {
    ...
    compositionEmpty: "No responses in this window.",
    correct: "Correct",
    incorrect: "Incorrect",
    responsesLower: "responses",
    trendEmpty: "No data in this window.",
    metricPctCorrect: "% correct",
    metricAvgTime: "Avg. time",
    metricParticipation: "Participation",
    topDominated: "Top strongest topics",
    topCritical: "Top critical topics",
    noTopics: "No topics registered.",
    topicTooltipHighlight: (label: string, val: number) => `${label}: ${val}% retention · click to highlight its questions`,
    topicTooltipView: (label: string, val: number) => `${label}: ${val}% retention · click to view the topic`,
    mostMissedTitle: "Most missed",
    highlighting: (topic: string) => `Highlighting: ${topic}`,
    notEnoughData: "Not enough data.",
    qErr: (p: number) => `${p}% err`,
    qLabel: (n: number) => `Q. ${n}`,
    genReviewTitle: "Create a review deck from the most-missed",
    atRiskTopics: "Topics at risk",
    avgTimeLabel: "Avg. time",
    participationLabel: "Participation",
    compare: "Compare",
    drawerSummaryOf: (name: string) => `Summary of ${name}`,
    close: "Close",
    ...
    cleoLabel: "Cleo:",
    cleoAnalyzing: "Cleo is analyzing the data…",
    cleoWeakTopics: (topics: string) => `The lowest-retention topics are: ${topics}.`,
    cleoNoData: "Not enough data in this date window.",
    cleoGenError: (err: string) => `I couldn't generate the review (${err}). Try again.`,
    cleoChipGenerate: "Generate review of weak topics",
    cleoChipGenerating: "Generating…",
    cleoChipReteach: "Reteach now",
    cleoChipTomorrow: "Have it come back tomorrow",
    cleoChipSoon: "soon",
    cleoGenerateTitle: "Creates a 7-question review deck on the weakest topics",
    cleoReteachTitle: "Jumps to the most-missed questions panel",
    cleoTomorrowTitle: "Arrives when the task scheduler ships",
  },
  ...
  studentProfile: {
    studentTitle: (name: string) => `Student: ${name}`,
    errorLoading: (msg: string) => `Error loading the profile: ${msg}`,
    avgRetention: "Avg. retention",
    deltaVsClass: "Δ vs class",
    trajectoryWeekly: "Trajectory · weekly % correct",
    noDataWindow: "No data in this window.",
    mostFailedTitle: "Student's most missed",
    notEnoughData: "Not enough data.",
    qLabel: (n: number) => `Q. ${n}`,
    qErr: (p: number) => `${p}% err`,
    assignReview: "Assign review",
    assignReviewTitle: "Create a review deck focused on this student",
    generating: "Generating…",
    masteryMatrix: "Mastery matrix",
    noTopicsYet: "No topics registered yet.",
    topicCountHint: (n: number, word: string) => `${n} ${word} · click to select`,
    topicWord: "topic",
    topicWordPlural: "topics",
    tierStrong: "strong",
    tierWeak: "weak",
    tierCritical: "critical",
    calculatingRisk: "Calculating risk…",
    noRiskData: "No risk data for this student.",
    riskAnalysis: (name: string) => `Risk analysis${name ? ` — ${name}` : ""}`,
    riskLevel: "Risk level",
    noRiskSignals: "No risk signals detected in the current window.",
    cleoLabel: "Cleo:",
    cleoAnalyzingStudent: "Cleo is analyzing the student…",
    cleoReinforce: (topics: string) => `Topics to reinforce: ${topics}.`,
    cleoAboveAvg: (d: number) => `They're ${d}% above the class average.`,
    cleoBelowAvg: (d: number) => `They're ${d}% below the class average.`,
    cleoNoData: "Not enough data in this window.",
    cleoGenError: (err: string) => `I couldn't generate the review (${err}). Try again.`,
    cleoAssign: "Assign review",
    cleoAssignTitle: "Creates a review deck focused on this student",
    cleoFamilyMsg: "Message to family",
    cleoFamilyTitle: "Arrives when family messaging ships",
    soon: "soon",
  ...
  topicMastery: {
    ...
    trendOf: (topic: string) => `Trend · ${topic}`,
    noTopicData: "No data for this topic.",
    questionsTitle: "Topic questions",
    noQuestions: "No questions for this topic.",
    qLabel: (n: number) => `Q. ${n}`,
    misconceptionTitle: "Misconception",
    selectQuestion: "Select a question to see the analysis.",
    correctAnswer: "Correct answer:",
    topWrong: "Most chosen (wrong):",
    chosePct: (n: number) => `${n}% chose this option`,
    otherQuestions: "Other missed questions",
    noOtherQuestions: "No additional questions with errors in this window.",
    misconceptionSubtitle: "Misconception · most-missed question",
    dominantMis: "Dominant misconception:",
    chosenSentence: (count: number, pct: number) => `chosen ${count} ${count === 1 ? "time" : "times"} (${pct}% of total).`,
    optionN: (n: number) => `Option ${n}`,
    trueLabel: "True",
    falseLabel: "False",
    correctMark: "✓ correct",
    viewInDeck: "View question in DeckResults",
    noFeatured: "No featured question for this topic.",
    errShort: (p: number) => `${p}% err`,
  },
  ...
  reportModel: {
    ...
    kpiAvgTime: "Avg. time (ms)",
    colTopic: "Topic",
    colRetention: "Retention",
    colQuestion: "Question",
    colError: "Error",
    overviewTitle: "General summary",
    avgRetention: "Average retention",
    activeClasses: "Active classes",
    students: "Students",
    sessions: "Sessions",
    colClass: "Class",
    reportTitle: (name: string, period: string) => `Report — ${name} (${period})`,
    overviewReportTitle: (period: string) => `General report (${period})`,
    qPrefix: (n: number) => `Q. ${n}`,
  },
  ...
  cleoChat: {
    ...
    // Action cards (Cleo proposes; teacher confirms before any write).
    action: {
      confirm: "Confirm",
      cancel: "Cancel",
      confirmPrompt: "Want me to go ahead?",
      working: "Working…",
      generating: "Building the quiz — this can take a moment…",
      canceled: "No problem — I won't do that.",
      failed: "That didn't work. You can try again, or do it manually.",
      createClassTitle: "Create class",
      createUnitTitle: "Create unit",
      reviewDeckTitle: "Generate review quiz",
      createDeckTitle: "Create quiz",
      fieldName: "Name",
      fieldGrade: "Grade",
      ...
      sourceDocument: "Your document",
      sourceTopic: "A topic",
      doneClass: "Done — I created the class “{name}”.",
      doneUnit: "Done — I created the unit “{name}”.",
      doneReview: "Done — your review quiz is saved as a draft.",
      doneDeck: "Done — “{name}” is saved as a draft with {count} questions.",
      viewClass: "Open class",
      viewUnit: "Open class",
      viewReview: "View in Library",
      viewDeck: "View in Library",
      ...
      fieldDeck: "Deck",
      fieldTo: "To",
      classLevel: "Class level (no unit)",
      renameClassTitle: "Rename class",
      renameUnitTitle: "Rename unit",
      renameDeckTitle: "Rename deck",
      moveDeckTitle: "Move deck",
      deleteDeckTitle: "Delete deck",
      deleteUnitTitle: "Delete unit",
      deleteClassTitle: "Delete class",
      deleteCta: "Delete",
      deleteKeyword: "delete",
      deleteWarn: "This can't be undone.",
      deleteClassWarn: "This permanently deletes the whole class — {students} students and {decks} decks. This can't be undone.",
      typeToConfirm: "Type “{name}” to confirm:",
      doneRenamed: "Done — renamed to “{name}”.",
      doneMoved: "Done — moved “{name}” to {unit}.",
      doneMovedToClass: "Done — moved “{name}” to the class level.",
      doneDeleted: "Done — deleted “{name}”.",
      viewClasses: "My classes",
    },
    // Multi-step plan card (Cleo chains several actions into one confirmation).
    plan: {
      heading: "Here's my plan",
      prompt: "Here's what I'll do — confirm below 👇",
      confirm: "Confirm & create",
      cancel: "Cancel",
      editNames: "Edit names",
      adjust: "Adjust",
      working: "…",
      runningNote: "Working on it…",
      summary: "{done} of {total} done",
      retry: "Retry the rest",
      canceled: "Okay — I won't run it.",
      view: "View",
      viewReport: "View report",
      open: "Open",
      launch: "Launch",
      openPlanner: "Open planner",
      sumCreateClass: "Create the class “{name}”",
      sumCreateUnit: "Add the unit “{name}” to {class}",
      sumCreateUnits: "Create {n} units in {class}",
      sumCreateDeck: "Build a quiz for {class}",
      sumReview: "Generate a review for “{unit}” ({class})",
      sumReport: "Open {class}'s report",
      sumOpen: "Take you there",
      sumLaunch: "Launch “{deck}”",
      sumSchedule: "Plan “{unit}” on the calendar",
      classLevel: "the class level",
      sumRenameClass: "Rename the class to “{new}”",
      sumRenameUnit: "Rename “{unit}” → “{new}” in {class}",
      sumRenameDeck: "Rename deck “{deck}” → “{new}”",
      sumMoveDeck: "Move “{deck}” to {to}",
      sumDeleteDeck: "Delete deck “{deck}”",
      sumDeleteUnit: "Delete unit “{unit}” ({class})",
      sumDeleteClass: "Delete the whole class “{class}”",
    },
  },
  ...
  classReport: {
    ...
    error: "Couldn't load the report. Try again in a moment.",
    emptyTitle: "No data yet",
    emptyBody: "Run a few warmups or exit tickets, then this report will fill with the hardest topics and who needs help.",
    kpiStudents: "Students",
    kpiTopics: "Topics",
    kpiAvgRetention: "Avg. retention",
    distributionTitle: "Topic retention",
    tierStrong: "strong",
    tierMedium: "needs review",
    tierWeak: "weak",
    hardestTitle: "Hardest topics",
    strongestTitle: "Strongest topics",
    studentsTitle: "Students who need help",
    answered: "{n} answered",
    noTopics: "No topics tracked yet.",
  ...
  decks: {
    ...
    aiImgModeAbout: "Ask about the image",
    aiImgCoverageLabel: "How many images",
    aiImgCoverageFew: "A few (auto)",
    aiImgCoverageSome: "~30% (recommended)",
    aiImgCoverageAll: "Every question",
    aiImgHintIllustrate: "The image sits beside the question as visual support — the question still makes sense without it.",
    aiImgHintAbout: "The question is about the image itself — it can't be answered without looking at it.",
    ...
    aiImagesAiPartialMsg: "Added {generated} AI-generated image(s). Removed {dropped} question(s) whose image didn't pass the quality check.",
    aiImagesAiFailedMsg: "Couldn't generate usable AI images this time. Removed {dropped} question(s) that were set to have one.",
