...
const en = {
  ...
  decks: {
    ...
    aiImagesLabel: "Images",
    aiImagesAttach: "Illustrate questions with images",
    aiImagesAbout: "Build questions about the images",
    aiImagesOff: "No images",
    aiImagesHintAttach: "The image sits beside the question as visual support — the question still makes sense without it.",
    aiImagesHintAbout: "The question is about the image itself — it can't be answered without looking at it.",
    aiImagesHintOff: "The document's images won't be used.",
    aiImagesAddedMsg: "Added {attached} image(s) from your document to the questions.",
    aiImagesNoneMsg: "Found {found} image(s) in your file, but none fit a question — try \"Build questions about the images\".",
