...
export default function StudentJoin({ lang: pageLang = "en", profile = null, practiceDeck = null, onPracticeExit = null, guestMode = false, guestPin = "", guestName = "", guestToken = "", onGuestKicked = null }) {
  ...
  useEffect(() => {
    if (timeLeft === 0 && !showResult && step === "quiz") {
      ...
      // kick off the auto-advance fill so the student gets 3 seconds
  ...
  // also runs 4000ms so the button visually completes its build-up
  // the moment handleNext fires. Manual click during the animation
  // still cancels the timer immediately.
  useEffect(() => {
