...
export default function SessionFlow({ lang = "en", setLang, onNavigateToDecks, onOpenMobileMenu, notifyActiveSessionChanged }) {
  ...
  const handleLaunch = async (config) => {
    ...
    // prefilled).
    if (!classId) {
      toaster.error(t.sessionNeedsClass || "This deck isn't linked to a class yet. Open the deck and add it to a class to start a session.");
