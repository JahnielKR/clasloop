...
const ICON_DEFS = {
  ...
  book: { color: D.blue, d: "M4,4 L4,18 C4,19.5 5.5,20 7,20 L20,20 L20,4 L7,4 C5.5,4 4,4.5 4,6 Z", extra: (c) => <><line x1="8" y1="8" x2="16" y2="8" stroke={c} strokeWidth="1.3" strokeLinecap="round" opacity="0.6"/><line x1="8" y1="11" x2="14" y2="11" stroke={c} strokeWidth="1.3" strokeLinecap="round" opacity="0.4"/><line x1="8" y1="14" x2="12" y2="14" stroke={c} strokeWidth="1.3" strokeLinecap="round" opacity="0.3"/></> },
  study: { color: D.blue, d: "M4,19 L12,14 L20,19 M4,15 L12,10 L20,15", extra: (c) => <circle cx="12" cy="7" r="3" fill={c} opacity="0.4"/> },
  question: { color: D.purple, d: "", extra: (c) => <><circle cx="12" cy="12" r="10" fill={c}/><path d="M9,9 C9,7 10.5,6 12,6 C13.5,6 15,7 15,9 C15,11 12,11 12,13" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" fill="none"/><circle cx="12" cy="16.5" r="1.2" fill="#fff"/></> },
  lightbulb: { color: D.gold, d: "M12,2 C8,2 5,5 5,9 C5,12 7,14 8,15 L8,18 C8,19 9,20 10,20 L14,20 C15,20 16,19 16,18 L16,15 C17,14 19,12 19,9 C19,5 16,2 12,2 Z", extra: (c) => <><line x1="10" y1="22" x2="14" y2="22" stroke={c} strokeWidth="1.5" strokeLinecap="round"/><path d="M10,15 L14,15" stroke={c} strokeWidth="1" opacity="0.4"/></> },
  ...
  xp: { color: D.purple, d: "M12,3 L14.5,8.5 L20.5,9 L16,13.5 L17,19.5 L12,17 L7,19.5 L8,13.5 L3.5,9 L9.5,8.5 Z", extra: (c) => <circle cx="12" cy="12" r="2.5" fill={c} opacity="0.5"/> },
  levelup: { color: D.green, d: "", extra: (c) => <><path d="M4,20 L12,4 L20,20 Z" fill={c} stroke={c} strokeWidth="1.8" strokeLinejoin="round"/><path d="M12,11 L12,16 M10,13 L12,11 L14,13" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none"/></> },
  streak: { color: D.orange, d: "M12,2 C6,10 4,14 8,20 C8,16 10,12 12,10 C14,12 16,16 16,20 C20,14 18,10 12,2 Z" },
  diamond: { color: D.blue, d: "M12,2 L4,10 L12,22 L20,10 Z", extra: (c) => <path d="M4,10 L20,10" stroke={c} strokeWidth="1" opacity="0.4"/> },
  comet: { color: D.orange, d: "M20,4 C16,4 10,8 6,14 C4,17 8,20 11,18 C15,14 18,8 20,4 Z", extra: (c) => <circle cx="8" cy="16" r="2" fill={c} opacity="0.5"/> },
  ...
  cross: { color: D.red, d: "", extra: (c) => <><circle cx="12" cy="12" r="10" fill={c}/><path d="M8,8 L16,16 M16,8 L8,16" stroke="#fff" strokeWidth="2" strokeLinecap="round" fill="none"/></> },
  warning: { color: D.orange, d: "", extra: (c) => <><path d="M12,3 L22,20 L2,20 Z" fill={c} stroke={c} strokeWidth="1.8" strokeLinejoin="round"/><line x1="12" y1="10" x2="12" y2="14" stroke="#fff" strokeWidth="2" strokeLinecap="round"/><circle cx="12" cy="17" r="1" fill="#fff"/></> },
  ...
  target: { color: D.red, d: "M12,2 A10,10 0 1,0 12,22 A10,10 0 1,0 12,2", extra: (c) => <><circle cx="12" cy="12" r="6" fill="none" stroke={c} strokeWidth="1.2" opacity="0.4"/><circle cx="12" cy="12" r="2" fill={c} opacity="0.6"/></> },
  clock: { color: D.blue, d: "", extra: (c) => <><circle cx="12" cy="12" r="10" fill={c}/><line x1="12" y1="7" x2="12" y2="12" stroke="#fff" strokeWidth="1.8" strokeLinecap="round"/><line x1="12" y1="12" x2="16" y2="14" stroke="#fff" strokeWidth="1.8" strokeLinecap="round"/></> },
  ...
  // ── Actions ──
  rocket: { color: D.blue, d: "M12,2 C12,2 8,6 8,14 L6,16 L8,18 L10,16 L14,16 L16,18 L18,16 L16,14 C16,6 12,2 12,2 Z", extra: (c) => <><circle cx="12" cy="10" r="2" fill={c} opacity="0.5"/><path d="M10,20 L12,22 L14,20" stroke={c} strokeWidth="1.5" fill="none"/></> },
  ...
  plus: { color: D.green, d: "", extra: (c) => <><circle cx="12" cy="12" r="10" fill={c}/><line x1="12" y1="8" x2="12" y2="16" stroke="#fff" strokeWidth="2" strokeLinecap="round"/><line x1="8" y1="12" x2="16" y2="12" stroke="#fff" strokeWidth="2" strokeLinecap="round"/></> },

  // ── People ──
  teacher: { color: D.blue, d: "M5,3 L19,3 L19,13 L5,13 Z", extra: (c) => <><line x1="9" y1="7" x2="15" y2="7" stroke={c} strokeWidth="1.5" strokeLinecap="round" opacity="0.6"/><line x1="9" y1="10" x2="13" y2="10" stroke={c} strokeWidth="1.5" strokeLinecap="round" opacity="0.3"/><path d="M7,13 L12,17 L17,13" stroke={c} strokeWidth="1.8" fill="none"/><line x1="12" y1="17" x2="12" y2="21" stroke={c} strokeWidth="1.5"/></> },
  ...
  pin: { color: D.green, d: "M6,3 L18,3 L18,21 L6,21 Z", extra: (c) => <><circle cx="12" cy="12" r="4" stroke={c} strokeWidth="1.5" strokeDasharray="3 2" fill="none"/><line x1="12" y1="9.5" x2="12" y2="14.5" stroke={c} strokeWidth="1.8" strokeLinecap="round"/><line x1="9.5" y1="12" x2="14.5" y2="12" stroke={c} strokeWidth="1.8" strokeLinecap="round"/></> },
  ...
  // ── Misc ──
  globe: { color: D.green, d: "M12,2 A10,10 0 1,0 12,22 A10,10 0 1,0 12,2", extra: (c) => <><ellipse cx="12" cy="12" rx="4" ry="10" fill="none" stroke={c} strokeWidth="1" opacity="0.4"/><line x1="2" y1="12" x2="22" y2="12" stroke={c} strokeWidth="1" opacity="0.4"/></> },
  flag: { color: D.red, d: "M5,3 L5,21 M5,3 L19,8 L5,13" },
  shield: { color: D.blue, d: "M12,2 L4,6 L4,12 C4,17 8,21 12,22 C16,21 20,17 20,12 L20,6 Z", extra: (c) => <path d="M9,12 L11,14 L15,10" stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none"/> },
  ...
  alert: { color: D.red, d: "", extra: (c) => <><circle cx="12" cy="12" r="10" fill={c}/><line x1="12" y1="8" x2="12" y2="13" stroke="#fff" strokeWidth="2.5" strokeLinecap="round"/><circle cx="12" cy="16.5" r="1.3" fill="#fff"/></> },
  ...
  sports: { color: D.green, d: "M12,2 A10,10 0 1,0 12,22 A10,10 0 1,0 12,2", extra: (c) => <><path d="M12,2 C8,6 8,18 12,22" stroke={c} strokeWidth="1.2" fill="none" opacity="0.5"/><path d="M2,12 L22,12" stroke={c} strokeWidth="1.2" opacity="0.5"/></> },
  map: { color: D.green, d: "M3,6 L9,3 L15,6 L21,3 L21,18 L15,21 L9,18 L3,21 Z", extra: (c) => <><line x1="9" y1="3" x2="9" y2="18" stroke={c} strokeWidth="1" opacity="0.3"/><line x1="15" y1="6" x2="15" y2="21" stroke={c} strokeWidth="1" opacity="0.3"/></> },
  science: { color: D.green, d: "M9,3 L9,10 L4,19 C3,21 5,22 7,22 L17,22 C19,22 21,21 20,19 L15,10 L15,3", extra: (c) => <><line x1="7" y1="3" x2="17" y2="3" stroke={c} strokeWidth="1.5" strokeLinecap="round"/><circle cx="11" cy="17" r="1.5" fill={c} opacity="0.5"/><circle cx="14" cy="15" r="1" fill={c} opacity="0.3"/></> },
  math: { color: D.blue, d: "M3,3 L21,3 L21,21 L3,21 Z", extra: (c) => <><text x="12" y="10" textAnchor="middle" fontSize="6" fontWeight="700" fill={c} opacity="0.7" fontFamily="sans-serif">+−</text><text x="12" y="18" textAnchor="middle" fontSize="6" fontWeight="700" fill={c} opacity="0.7" fontFamily="sans-serif">{"\u00D7"}÷</text></> },
  history: { color: D.orange, d: "M4,4 C4,4 8,2 12,4 C16,6 20,4 20,4 L20,18 C20,18 16,20 12,18 C8,16 4,18 4,18 Z" },
  language: { color: D.blue, d: "M4,4 L20,4 L20,16 L14,16 L12,20 L10,16 L4,16 Z", extra: (c) => <><text x="12" y="12.5" textAnchor="middle" fontSize="7" fontWeight="600" fill={c} opacity="0.7" fontFamily="sans-serif">Aa</text></> },
  geo: { color: D.green, d: "M12,2 A10,10 0 1,0 12,22 A10,10 0 1,0 12,2", extra: (c) => <><ellipse cx="12" cy="12" rx="4" ry="10" fill="none" stroke={c} strokeWidth="1" opacity="0.4"/><path d="M3,8 L21,8 M3,16 L21,16" stroke={c} strokeWidth="1" opacity="0.3"/></> },
  art: { color: D.purple, d: "M12,2 A10,10 0 1,0 12,22 A10,10 0 1,0 12,2", extra: (c) => <><circle cx="8" cy="8" r="1.5" fill={D.red}/><circle cx="15" cy="7" r="1.5" fill={D.blue}/><circle cx="8" cy="15" r="1.5" fill={D.green}/><circle cx="16" cy="14" r="1.5" fill={D.gold}/><circle cx="12" cy="18" r="2" fill={c}/></> },
  other: { color: D.muted, d: "M12,2 A10,10 0 1,0 12,22 A10,10 0 1,0 12,2", extra: (c) => <><circle cx="8" cy="12" r="1.3" fill={c}/><circle cx="12" cy="12" r="1.3" fill={c}/><circle cx="16" cy="12" r="1.3" fill={c}/></> },
  ...
  weekend: { color: D.blue, d: "M4,4 L20,4 L20,20 L4,20 Z", extra: (c) => <><line x1="4" y1="8" x2="20" y2="8" stroke={c} strokeWidth="1.2" opacity="0.4"/><text x="12" y="16" textAnchor="middle" fontSize="8" fontWeight="700" fill={c} opacity="0.7" fontFamily="sans-serif">7</text></> },
  speed: { color: D.gold, d: "", extra: (c) => <><path d="M13,2 L5,14 L11,14 L10,22 L19,10 L13,10 Z" fill={c} opacity="0.8" stroke={c} strokeWidth="1"/></> },
  multilingual: { color: D.blue, d: "M12,2 A10,10 0 1,0 12,22 A10,10 0 1,0 12,2", extra: (c) => <><text x="12" y="14" textAnchor="middle" fontSize="7" fontWeight="600" fill={c} opacity="0.8" fontFamily="sans-serif">Ab</text><ellipse cx="12" cy="12" rx="4" ry="10" fill="none" stroke={c} strokeWidth="0.8" opacity="0.3"/></> },
  founding: { color: D.blue, d: "M12,2 C12,2 8,6 8,14 L6,16 L8,18 L10,16 L14,16 L16,18 L18,16 L16,14 C16,6 12,2 12,2 Z", extra: (c) => <><circle cx="12" cy="10" r="2" fill={c} opacity="0.5"/><path d="M10,20 L12,22 L14,20" stroke={D.orange} strokeWidth="1.5" fill="none"/></> },
  news: { color: D.blue, d: "M4,3 L20,3 L20,21 L4,21 Z", extra: (c) => <><rect x="7" y="6" width="10" height="5" rx="1" fill={c} opacity="0.3"/><line x1="7" y1="14" x2="17" y2="14" stroke={c} strokeWidth="1.2" strokeLinecap="round" opacity="0.4"/><line x1="7" y1="17" x2="14" y2="17" stroke={c} strokeWidth="1.2" strokeLinecap="round" opacity="0.3"/></> },
  school: { color: D.green, d: "M5,20 L5,11 L12,6 L19,11 L19,20", extra: (c) => <><rect x="9" y="14" width="6" height="6" rx="1" fill={c} opacity="0.3" stroke={c} strokeWidth="0.8"/><circle cx="12" cy="11" r="1.5" fill={c} opacity="0.5"/><path d="M17,7 L17,4 L20,5.5 Z" fill={D.orange}/></> },
