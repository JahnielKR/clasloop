...
export default function ResponseCompositionPanel({ kpis = {} }) {
  ...
  const data = [
    { name: t.correct, value: correct, color: PALETTE.correct },
    { name: t.incorrect, value: incorrect, color: PALETTE.incorrect },
  ];
      ...
      {total === 0 ? (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <Donut
            ...
            centerSubLabel={t.responsesLower}
            height={150}
          />
          <div style={{ fontSize: 13, lineHeight: 1.8 }}>
            <LegendRow color={PALETTE.correct} label={t.correct} value={correct} total={total} />
            <LegendRow color={PALETTE.incorrect} label={t.incorrect} value={incorrect} total={total} />
          </div>
        </div>
      )}
    </div>
